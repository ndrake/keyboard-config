...
[_MAC] = LAYOUT(
         ...
         KC_ESC, KC_F1, KC_F2, KC_F3, KC_MPRV, KC_MPLY, KC_MNXT, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_MUTE, KC_VOLD, KC_VOLU, DF(1), QK_BOOT,
         KC_EQL, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS,
         KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSLS,
         KC_CAPS, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT,
         KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
                KC_GRV, KC_INS, KC_LEFT, KC_RGHT,              KC_UP, KC_DOWN, KC_LBRC, KC_RBRC,
                // THUMB CLUSTERS
                KC_LGUI, KC_LALT,                   KC_LCTL,KC_LGUI,
                KC_HOME,                            KC_PGUP,
...
[_WIN] = LAYOUT(
         ...
         KC_ESC, KC_F1, KC_F2, KC_F3, KC_MPRV, KC_MPLY, KC_MNXT, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_VOLU, KC_VOLD, KC_MUTE, DF(0), QK_BOOT,
         KC_EQL, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS,
         KC_TAB, KC_Q, KC_W, KC_E, KC_R, KC_T, KC_Y, KC_U, KC_I, KC_O, KC_P, KC_BSLS,
         KC_CAPS, KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT,
         KC_LSFT, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT,
                KC_GRV, KC_INS, KC_LEFT, KC_RGHT,              KC_UP, KC_DOWN, KC_LBRC, KC_RBRC,
                // THUMB CLUSTERS
                KC_LCTL, KC_LALT,                   KC_LCTL, KC_LGUI,
                KC_HOME,                            KC_PGUP,
                KC_BSPC, KC_DEL, KC_END,            KC_PGDN, KC_ENT, KC_SPC
    ),
};
